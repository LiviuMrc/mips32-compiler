...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASSIGN", "LOOP",
  "DELAY", "IF", "ELSE", "NUM", "LD", "SW", "'='", "';'", "'{'", "'}'",
  "'('", "')'", "$accept", "program", "stmtlist", "stmt", YY_NULLPTR
};
...
{
      16,    -9,    -5,     8,     7,    28,   -10,    16,    18,    19,
      30,   -10,   -10,    -3,   -10,    14,    20,    29,    31,   -10,
     -10,    32,    33,   -10,   -10,   -10,    16,     3,    35,    34,
      16,    10,   -10
};
...
{
       6,     1,     2,     3,     7,    12,     4,     1,     2,     3,
       8,    19,     4,    20,     1,     2,     3,    28,    10,     4,
       1,     2,     3,     9,    32,     4,    15,    20,    11,    16,
      21,    20,     1,     2,     3,    27,    22,     4,    17,    31,
      18,    23,    29,    24,    25,     0,    26,    30
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     6,    13,     5,     9,     4,     5,     6,
      15,    14,     9,    13,     4,     5,     6,    14,    11,     9,
       4,     5,     6,    15,    14,     9,     8,    27,     0,    10,
      16,    31,     4,     5,     6,    26,    16,     9,     8,    30,
      10,    12,     7,    12,    12,    -1,    13,    13
};
...
{
       0,     4,     5,     6,     9,    18,    20,    13,    15,    15,
      11,     0,    20,    19,    20,     8,    10,     8,    10,    14,
      20,    16,    16,    12,    12,    12,    13,    19,    14,     7,
      13,    19,    14
};
...
yyreduce:
  ...
  case 2: /* program: stmt  */
#line 37 "parser.y"
                                { root = (yyval.node) = (yyvsp[0].node); }
#line 1377 "parser.c"
    break;

  case 3: /* program: program stmt  */
#line 38 "parser.y"
                                { root = (yyval.node) = block((yyvsp[-1].node), (yyvsp[0].node)); }
#line 1383 "parser.c"
    break;
...
#line 42 "parser.y"
                                { (yyval.node) = block((yyvsp[-1].node), (yyvsp[0].node)); }
#line 1395 "parser.c"
    break;

  case 6: /* stmt: LD '=' NUM ';'  */
#line 45 "parser.y"
                                { (yyval.node) = opToNode(tAssign, 2, constToNode((yyvsp[-1].val)), varToNode((yyvsp[-3].var))); }
#line 1401 "parser.c"
    break;

  case 7: /* stmt: LD '=' SW ';'  */
#line 46 "parser.y"
                                { (yyval.node) = opToNode(tAssign, 2, varToNode((yyvsp[-1].var)), varToNode((yyvsp[-3].var))); }
#line 1407 "parser.c"
    break;

  case 8: /* stmt: LOOP '{' stmtlist '}'  */
#line 47 "parser.y"
                                { (yyval.node) = opToNode(tLoop, 1, (yyvsp[-1].node)); }
#line 1413 "parser.c"
    break;

  case 9: /* stmt: DELAY '(' NUM ')' ';'  */
#line 48 "parser.y"
                                { (yyval.node) = opToNode(tDelay, 1, constToNode((yyvsp[-2].val))); }
#line 1419 "parser.c"
    break;

  case 10: /* stmt: IF '(' SW ')' '{' stmtlist '}'  */
#line 49 "parser.y"
                                                { (yyval.node) = opToNode(tIf, 2, varToNode((yyvsp[-4].var)), (yyvsp[-1].node)); }
#line 1425 "parser.c"
    break;

  case 11: /* stmt: IF '(' SW ')' '{' stmtlist '}' ELSE '{' stmtlist '}'  */
#line 50 "parser.y"
                                                                { (yyval.node) = opToNode(tIf, 3, varToNode((yyvsp[-8].var)), (yyvsp[-5].node), (yyvsp[-1].node)); }
#line 1431 "parser.c"
    break;
